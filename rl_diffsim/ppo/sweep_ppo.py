...
sweep_configuration = {
    ...
    "parameters": {
        ...
        "gamma": {"min": 0.93, "max": 0.98},
        "gae_lambda": {"min": 0.93, "max": 0.98},
        ...
        "max_vel": {"distribution": "uniform", "min": 2.0, "max": 4.5},
        "cont_gate_safe_dist": {"distribution": "uniform", "min": 0.1, "max": 0.2},
        "cont_obst_safe_dist": {"distribution": "uniform", "min": 0.2, "max": 0.25},
        # "gate_size_1": {"distribution": "uniform", "min": 0.2, "max": 0.5},
        "gate_vel_coef": {"distribution": "uniform", "min": 2.0, "max": 5.0},
        # "gate_vel_coef_1": {"distribution": "uniform", "min": 0.0, "max": 1.0},
        "contact_coef": {"distribution": "uniform", "min": 10.0, "max": 15.0},
