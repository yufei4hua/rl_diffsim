...
# register(
#     id="DroneRacing-v0",
#     entry_point="rl_diffsim.envs.drone_race:DroneRaceEnv",
#     vector_entry_point="rl_diffsim.envs.drone_race:VecDroneRaceEnv",
...
#     entry_point="rl_diffsim.envs.real_race_env:RealDroneRaceEnv",
