...
class Args:
    ...
    jax_device: str = "cpu"
    """environment device"""
    exp_name: str = "bptt_rp"
    """the name of the experiment"""
    wandb_project_name: str = "rl-bptt-rp"
    ...
    # Wrapper settings
    rpy_coef: float = 0.0
    act_coefs: tuple = (0.05, 0.05, 0.0, 0.2)
    d_act_coefs: tuple = (1.0, 1.0, 0.0, 2.0)
...
def train_bptt(args: Args, model_path: Path, jax_device: str, wandb_enabled: bool = False) -> None:
    ...
    envs = make_jitted_envs(
        num_envs=args.num_envs, jax_device=jax_device, coefs=r_coefs, reset_rotor=True, reset_random=True
    )
